  ...
  processConfigurations.processConfigurationParameters.forEach((config) => {
    if (config.metaModel) {
      ...
      modelList.push({
        ...
        type: "metaModel",
        title: config.metaModelLabel.substring(
      ...
      modelList.push({
        ...
        type: "metaJsonModel",
        title: config.metaJsonModelLabel.substring(
    ...
    isVisible && (
      <div>
        ...
        {open && (
          ...
          >
            <DialogTitle id="alert-dialog-title">Collection</DialogTitle>
            ...
            <DialogActions>
              <Button
                onClick={() => {
                  ...
                  const value = `${prefix}${lowerCaseFirstLetter(
                    model.name
                  )}.${collectionVal})}`;
                  setCollection(value);
                  let loopCharacteristics = getLoopCharacteristics(element);
