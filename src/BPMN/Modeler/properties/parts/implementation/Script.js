...
export default function Script(
  ...
  return {
    template:
      ...
      "</div>" +
      '<div class="bpp-row bpp-textfield">' +
      '<label for="cam-script-resource-val" data-show="script.isScriptResource">' +
      ...
      "</div>" +
      '<div class="bpp-row">' +
      '<label for="cam-script-val" data-show="script.isScript">' +
    ...
    isScriptResource: function (element, inputNode, btnNode, scopeNode) {
      let scriptType = getScriptType(scopeNode);
